  ...
  for (const candidate of candidates) {
    ...
    for (const term of group.terms) {
      ...
      entries.push({
        ...
        url: section.historical?.sourceUrl || section.url || section.source?.url,
        captureDate: section.historical?.sourceCapturedAt || section.source?.captureDate || definitionSource.capturedAt,
        ...(section.historical ? { historical: true } : {}),
